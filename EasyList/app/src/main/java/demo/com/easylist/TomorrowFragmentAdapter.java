...
public class TomorrowFragmentAdapter extends RecyclerView.Adapter<TomorrowFragmentAdapter.MyViewHolder> {

    private Context context;
    private ArrayList<String> arrayList;
    DatabaseSource databaseSource;

    public TomorrowFragmentAdapter(Context context, ArrayList<String> arrayList)
    {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public void getData(int position) {
            ...
            String noOfTask = databaseSource.getTodayTaskNameByType(arrayList.get(position), "Tomorrow");
